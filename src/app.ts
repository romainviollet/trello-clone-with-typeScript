...
// listing all items container for add eventListener
itemsContainer.forEach((container: HTMLDivElement) => {
    addContainerListeners(container);
});

//Add event listener for delete buttons, add buttons, close buttons, drag And drop containers...
...
// Add event listeners on swap elements
